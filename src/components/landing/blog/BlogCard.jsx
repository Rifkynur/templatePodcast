...
const BlogCard = ({ title, title1, date, tag, img }) => {
  return (
    <Link to={"/blog-details"} className="cursor-pointer">
      <div className={`border-2 bg-white border-black rounded-lg p-2 ${title === "PODCAST" ? "shadow-blogShadowSmall lg:shadow-blogShadowBig" : ""}   lg:w-[570px]`}>
