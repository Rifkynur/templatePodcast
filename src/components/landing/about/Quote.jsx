...
const Quote = () => {
  return (
    <div className="relative bg-primary w-[90%] mx-auto flex flex-col items-center mt-5 py-2 gap-2 shadow-md md:mt-10 md:py-8 lg:py-10 lg:mt-32 lg:gap-10">
      ...
      <p className="text-sm text-center font-bold max-w-[250px] md:text-2xl md:max-w-[450px] lg:text-4xl lg:max-w-[700px]">One of the best daily podcasts that covers every topic on Spotify.</p>
